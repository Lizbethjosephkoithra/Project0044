...
public class CameraAdpater extends BaseAdapter {
    ...
    List<GetCameraSet> _data;
    Context _c;
    ViewHolder v;

    public CameraAdpater(List<GetCameraSet> getData, Context context) {
        _data = getData;
        _c = context;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = li.inflate(R.layout.camera_row, null);
        } else {
            view = convertView;
        }
        ...
        final GetCameraSet dataSet = (GetCameraSet) _data.get(position);
    ...
    public void setImageInItem(int position, Bitmap imageSrc, String imagePath) {
        GetCameraSet dataSet = (GetCameraSet) _data.get(position);
